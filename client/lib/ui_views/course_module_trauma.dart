...
List<String> imageList = [
  'images/courses/trauma/1.JPG',
  'images/courses/trauma/2.JPG',
  'images/courses/trauma/3.JPG',
  'images/courses/trauma/4.JPG',
  'images/courses/trauma/5.JPG',
  'images/courses/trauma/6.JPG'
];
...
class TraumaSliderModule extends StatefulWidget {
  const TraumaSliderModule({Key? key}) : super(key: key);

  @override
  State<StatefulWidget> createState() {
    return _TraumaSliderModuleState();
  }
}

class _TraumaSliderModuleState extends State<TraumaSliderModule> {
